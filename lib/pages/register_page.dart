  ...
  void signUserUp() async {
    ...
    try {
      ...
      if (passwordController.text.trim() == passwordController.text.trim()) {
        ...
        // create a user document add add to firestore
        AuthService authService = AuthService();
        await authService.createUserDocument(userCredential);
      ...
      // ignore: use_build_context_synchronously
      Navigator.pop(context);
      showErrorMsg(e.code.replaceAll("-", " "));
    }
  }
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: Text(msg[0].toUpperCase() + msg.substring(1)),
        );
      },
    );
  }
